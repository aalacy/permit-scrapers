...
myutil = Util('Broward', 'Weston')

class WestonSpider(CrawlSpider):
	name = 'Weston'
	...
	def __init__(self):
		super(WestonSpider, self).__init__()		
	...
	def start_requests(self):
		...
		request = scrapy.Request(url=self.base_url, headers=headers, callback=self.parse_pagination)
		request.meta['page'] = 1
		yield request
	# def parse_temp(self, response):
	# 	res = requests.get(self.base_url)
	# 	return self.parse_pagination(Selector(text=res.text))		
	...
	def parse_pagination(self, response):
		...
		formdata = {
			...
			"ctl00$PlaceHolderMain$generalSearchForm$txtGSStartDate": "07/13/1993",
			...
			"ctl00$PlaceHolderMain$generalSearchForm$txtGSDescription": "",
		...
		headers = {
			...
			'cookie': 'ACA_USER_PREFERRED_CULTURE=en-US; ACA_COOKIE_SUPPORT_ACCESSSIBILITY=False; _pendo_accountId.08c27448-9075-481d-584f-0c00aac03d50=WESTON; _pendo_visitorId.08c27448-9075-481d-584f-0c00aac03d50=31BCA02094EB78126A517B206A88C73CFA9EC6F704C7030D18212CACE820F025F00BF0EA68DBF3F3A5436CA63B53BF7BF80AD8D5DE7D8359D0B7FED9DBC3AB99; _pendo_meta.08c27448-9075-481d-584f-0c00aac03d50=1655508987; LASTEST_REQUEST_TIME=1606469115226; .ASPXANONYMOUS=xpu1QYaFFsbfrJzTTqIlUx-yMfwgWNn1Wy9Z59s5dORfm-mSumy_Non5b9uAb7juSOpvvOeL5KsoaavBI0JVS3FmGsqyR8LtCQZacaFzPMweC6QyAoiYqALFiIWjEOsay52V3ZbCglq5pkkLhcRgDGZ8yGDy3uQY7tp6lC8a5T_iZYtHhBJX9qTkBKKHIPnX0; ACA_SS_STORE=1e0cvj4f2jkb4ccclo0q5cg1; ACA_CS_KEY=9626b2394ca04e2cabf7ce1a8e06a040; ApplicationGatewayAffinity=35ba0760a33cd116cc9372b0d2fe1709aa8ae394d6c5ba58e596480d41a2c1e4; ApplicationGatewayAffinityCORS=35ba0760a33cd116cc9372b0d2fe1709aa8ae394d6c5ba58e596480d41a2c1e4'
		}
