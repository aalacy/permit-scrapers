...
myutil = Util('Broward', 'Dania')

class DaniaSpider(CrawlSpider):
	name = 'Dania'
	...
	base_url = 'https://mydaniabeach.com/eSuite.Permits/AdvancedSearchPage/AdvancedSearch.aspx'

	data = {}

	def __init__(self):
		super(DaniaSpider, self).__init__()		
	...
	def parse_type(self, response):
		...
		for option in options:
			...
			url = f'https://mydaniabeach.com/eSuite.Permits/AdvancedSearchPage/AdvancedSearch.aspx?permitNumber=&permitType={value}&serviceAddress='
	...
	def parse_type_pagination(self, response):
		...
		for _page in pages:
			...
			if not page.isnumeric():
				continue
			referer = f'https://mydaniabeach.com/eSuite.Permits/AdvancedSearchPage/AdvancedSearch.aspx'
	...
	def parse_content(self, response):
		...
		for tr in trs:
			...
			url = f'https://mydaniabeach.com/eSuite.Permits{_url[2:]}'
